...
public class AudioVolumeEditWindow : EditorWindow
{
    ...
    void refreshAudioData()
    {
        ...
        //UI
        foreach(object music in Enum.GetValues(typeof(RomanWhen.UIMusic)))
        {
        ...
        // Scene
        foreach (object music in Enum.GetValues(typeof(RomanWhen.SceneMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            AudioModel model = new AudioModel();
    ...
    public void SaveJson(string Filepath)
    {
        ...
        MergeDictionaries.Fetus(dic, UIAudioGroup);
        MergeDictionaries.Fetus(dic, SceneAudioGroup);
