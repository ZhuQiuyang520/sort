...
#if UNITY_ANDROID
                AppLovinSettings.Instance.desKey = DrawTextField("AppLovin SDK Key", AppLovinSettings.Instance.desKey, GUILayout.Width(privacySettingLabelWidth), privacySettingFieldWidthOption);
#else
                AppLovinSettings.Instance.SdkKey = DrawTextField("AppLovin SDK Key", AppLovinSettings.Instance.SdkKey, GUILayout.Width(privacySettingLabelWidth), privacySettingFieldWidthOption);
#endif
                GUILayout.BeginHorizontal();
