...
public class CashOutEnter : MonoBehaviour
{
    ...
    void Start()
    {
        CashOutManager.PutCambrian()._CashOutEnter = this;
        OpenPanelBtn.onClick.AddListener(() => { UIImagery.PutCambrian().ShunUIShiny(nameof(CashOutPanel)); });
        UpdateMoney();
    }
    ...
    public void UpdateMoney()
    {
        ...
        MoneyTextAnim = DOTween.To(() => MoneyStart, x => MoneyText.text = x.ToString("F2"), CashOutManager.PutCambrian().Money, 1f);
