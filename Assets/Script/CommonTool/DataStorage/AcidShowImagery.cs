...
public class AcidShowImagery
{
    ...
    public static void AntTest(string key, bool value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static bool PutTest(string key)
    {
        try
        {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void AntMeadow(string key, string value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static string PutMeadow(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void AntCramp(string key, float value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static float PutCramp(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void AntRat(string key, int value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static int PutRat(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void AntRatBuyer(string key, int[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static int[] PutRatBuyer(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void AntCrampBuyer(string key, float[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static float[] PutCrampBuyer(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void AntMeadowBuyer(string key, string[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static string[] PutMeadowBuyer(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void AntCactus2(string key, Vector2 value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Vector2 PutCactus2(string key)
    {
        Vector2 Vector2;
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void AntCactus3(string key, Vector3 value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Vector3 PutCactus3(string key)
    {
        Vector3 vector3;
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void AntConference(string key, Quaternion value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Quaternion PutConference(string key)
    {
    ...
    public static void AntInvade(string key, double value)
    {
        PlayerPrefs.SetString(key, value.ToString());
    }

    public static double PutInvade(string key)
    {
