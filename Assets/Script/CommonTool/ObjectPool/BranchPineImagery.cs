...
using UnityEngine;
using System;
public class BranchPineImagery : BeerZoologist<BranchPineImagery>
{
    //管理objectpool的字典
    private Dictionary<string, BranchPine> m_PineWax;
    private Transform m_HangLifeblood=null;
    //构造函数
    public BranchPineImagery()
    {
        m_PineWax = new Dictionary<string, BranchPine>();      
    }
    
    //创建一个新的对象池
    public T TariffBranchPine<T>(string poolName) where T : BranchPine, new()
    {
