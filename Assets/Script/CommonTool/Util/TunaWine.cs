...
public class TunaWine
{
    public static long Bizarre()
    {
        return PutAdornment(DateTime.Now);
    }

    public static long PutAdornment(DateTime datetime)
    {
    ...
    /// <returns></returns>
    public static string TunaWakeBestow(DateTime dt, string format)
    {
        return dt.ToString(format);
    }

    public static DateTime CrumpleUpTunaWake(long seconds)
    {
        DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1)); // 当地时区
    ...
    /// <returns></returns>
    public static string CrumpleBestow(long totalTime, string connector = ":")
    {
    ...
    /// <param name="totalTime"></param>
    /// <returns></returns>
    public static string CrumpleBestow2(long totalTime)
    {
        int seconds = Mathf.Max((int)(totalTime % 60), 0);
        int minutes = Mathf.Max((int)(totalTime / 60) % 60, 0);
