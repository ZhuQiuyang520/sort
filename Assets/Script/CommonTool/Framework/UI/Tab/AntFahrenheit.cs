...
public class AntFahrenheit : MonoBehaviour
{
    [SerializeField]
...
[UnityEngine.Serialization.FormerlySerializedAs("ActiveTab")]    public GameObject DevoidAnt;
    ...
    public GameObject TaskAnt(string _tabName)
    {
        ...
        {
            if (HitBeacon[GrowthAntHiss].GetComponent<TurnUIShiny>() != null)
            {
                HitBeacon[GrowthAntHiss].GetComponent<TurnUIShiny>().Hidding();
            }
            else
            {
        ...
        foreach (TabItem tabItem in Smoke)
        {
            tabItem.AntInnate.GetComponent<AntRaftFahrenheit>().AntDevoidUI(tabItem.AntHiss.Equals(_tabName), this, tabItem);
        ...
        {
            if (HitBeacon[_tabName].GetComponent<TurnUIShiny>() != null)
            {
                HitBeacon[_tabName].GetComponent<TurnUIShiny>().Display(null);
            }
            else
            {
