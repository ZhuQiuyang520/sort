...
public class ExciteImageryOrYarn : IExciteImagery
{
    //保存键值对应用设置集合
    ...
    public ExciteImageryOrYarn(string jsonPath)
    {
    ...
    private void TactWedHesitantYarn(string jsonPath)
    {
        ...
        {
            throw new YarnEmotiveGoldsmith(GetType() + "/InitAndAnalysisJson()/Json Analysis Exception ! Parameter jsonPath=" + jsonPath);
        }
        //数据加载到AppSetting集合中
