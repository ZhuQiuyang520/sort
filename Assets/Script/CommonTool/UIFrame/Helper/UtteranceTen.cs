...
public class UtteranceTen : MonoBehaviour
{
    /* 字段 */
    private static UtteranceTen _Cambrian;              //本脚本私有单例实例
    ...
    /// </summary>
    /// <returns></returns>
    public static UtteranceTen PutCambrian()
    {
        if (_Cambrian == null)
        {
            _Cambrian = new GameObject("_ResourceMgr").AddComponent<UtteranceTen>();
        }
        return _Cambrian;
    }
